...
function Load-Children {
    ...
    try {
        ...
        Write-Error "Access is denied. Here is the error information:`n`n$_"
    }
}
...
$NewFolderButton.Add_Click({
    ...
    try {
        ...
        Display-Message "Failed to create folder.`n`n$($_.Exception.Message)" ([System.Windows.MessageBoxButton]::OK) ([System.Windows.MessageBoxImage]::Error) | Out-Null
    }
})
$RenameButton.Add_Click({
    ...
    try {
        ...
        Display-Message "Failed to rename folder.`n`n$($_.Exception.Message)" ([System.Windows.MessageBoxButton]::OK) ([System.Windows.MessageBoxImage]::Error) | Out-Null
    }
})
$DeleteButton.Add_Click({
    ...
    $result = Display-Message "Delete this folder and everything inside it?`n`n$path" ([System.Windows.MessageBoxButton]::YesNo) ([System.Windows.MessageBoxImage]::Warning)
    if ($result -ne [System.Windows.MessageBoxResult]::Yes) { return }
    try {
        Remove-Item -LiteralPath $path -Recurse -Force
        Refresh-Drives
    } catch {
        Display-Message "Failed to delete folder.`n`n$($_.Exception.Message)" ([System.Windows.MessageBoxButton]::OK) ([System.Windows.MessageBoxImage]::Error) | Out-Null
    }
})
